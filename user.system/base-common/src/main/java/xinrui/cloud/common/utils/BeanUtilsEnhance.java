...
public class BeanUtilsEnhance {
    ...
    public static <T, Z>  List<T> copyList(List<Z> sources, Class<T> targetClazz, final String... ignoreFields) {
        return copyList(sources, targetClazz, new CopyListFilter<T, Z>() {
            @Override
            public  T copy(Z source, T target) {
     ...
     * @return  源类型的List
     */
    public static <T, S> List<T> copyList(List<S> sources, Class<T> targetClazz, CopyListFilter<T, S> copyListFilter) {
